    ...
    <div class="add-assignment">
        ...
        <el-form ref="formRef" :model="form" :rules="rules" label-position="top" class="task-form" style="flex: 1">
            <div class="add-assignment-content">
                ...
                <div class="content-item">
                    <!-- 航线精度类型 -->
                    <el-form-item label="任务类型" prop="task_type" class="flex-1">
                        <div class="content-item-content1">
                            <div class="content-item-tab" :class="{ active: form.task_type === 0 }" @click="form.task_type = 0">立即</div>
                            <div class="content-item-tab" :class="{ active: form.task_type === 1 }" @click="form.task_type = 1">定时</div>
                            <div class="content-item-tab" :class="{ active: form.task_type === 2 }" @click="form.task_type = 2">循环</div>
                        </div>
                    </el-form-item>
                </div>
                <!-- 循环参数 -->
                <div class="content-item" v-if="form.task_type == 2">
                    <CycleForm ref="cycleFormRef" label-position="top" class="task-form" style="flex: 1" />
                </div>
                <!-- 开始执行时间 -->
                <div class="content-item" v-if="form.task_type == 1">
                    <FormItem
                        class="flex-1"
                ...
                <div class="content-item">
                    <FormItem
                        ...
                        prop="airline_id"
                        :input-attr="{ pk: 'airline.id', field: 'name', remoteUrl: '/admin/Airline/index', params }"
                ...
                <div class="content-item">
                    <FormItem
                        ...
                        prop="equipment_id"
                        :input-attr="{ pk: 'equipment.id', field: 'nickname', remoteUrl: '/admin/Equipment/index', params }"
...
import CycleForm from './assignment/cycle.vue'
...
const submit = async () => {
    // 如果是循环任务，合并两个表单
    if (form.value.task_type === 2) {
        Object.assign(form.value, cycleFormRef.value.throwCycleForm())
    }
