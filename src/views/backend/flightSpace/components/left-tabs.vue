<template>
    <div class="left-tabs-container">
        ...
        <div class="left-content">
            <component :is="tabsList[activeTab].component" ref="components" />
        </div>
    </div>
</template>

<script setup lang="ts">
import { ref, inject, watch, markRaw, computed, onMounted, nextTick } from 'vue'
...
const tabsList = ref([
    ...
    { name: '模型', image: '/img/image/tabs2.png', component: markRaw(Logotype) },
...
const handleProjectChange = (val: string) => {
    ...
    console.log('项目详情', currentProject.value)
}
