<template>
    <el-scrollbar ref="layoutMenuScrollbarRef" class="vertical-menus-scrollbar">
        ...
        >
            ...
            <el-menu-item @click="outLogin" index="1">
                <el-icon style="cursor: pointer" size="20"><SwitchButton /></el-icon>
                <span>退出登录</span>
            </el-menu-item>
            <el-menu-item @click="handleMenuBottomItemClick(1)" index="1">
                <img src="/img/menu/menu9.png" alt="" style="width: 20px; height: 20px; margin-right: 10px" />
                <span>收起</span>
            </el-menu-item>
        </el-menu>
    </el-scrollbar>
...
const menuText = ['数据看板', '飞行空间', '设备管理', '飞行记录', '应用中心', '视觉算法中心', '模型管理', '系统更新']
const menuImage = [
    '/img/menu/menu1.png',
    '/img/menu/menu2.png',
