...
# -*- coding: utf-8 -*-
"""
UAV 禁飞区地图 — Flask 应用入口
仅负责：路由注册与请求分发，所有业务逻辑委托给各服务模块。
"""
...
from data_loader      import load_shapefile_async, get_state, get_gdf
from building_service import query_buildings, prepare_sub
from osm_service      import download_osm, osm_to_geojson

from exporters.sumo_poly     import export_sumo_poly
from exporters.sumo_net_grid import export_grid_net
from exporters.sumo_net_osm  import osm_to_sumo_net
from exporters.geofile       import export_geojson, export_csv
...
# 开发模式下允许 Vite 开发服务器（localhost:5173）跨域访问 API
